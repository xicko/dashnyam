          ...
          <div>
            <div className="px-8">
              <div className="flex md:flex-row flex-col justify-between md:space-x-14 md:gap-0 gap-14">
                <div className="max-w-xs bg-zinc-200 dark:bg-black bg-opacity-60 rounded-2xl md:px-10 px-6 py-8 md:order-1 order-3 h-[500px]">
                ...
                <div className="max-w-xs md:order-3 order-2">
                  ...
                  <p className="text-xl tracking-wider">
                    We prioritize our clients&apos; success by understanding
                    their goals and delivering tailored solutions that drive
                    real growth for their business.
                  </p>
                </div>
              </div>
            </div>
