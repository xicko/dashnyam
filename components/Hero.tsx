...
const Hero = () => {
  return (
    <section className="flex justify-center">
      <div className="flex justify-center flex-col md:w-[1400px] md:pt-[168px] pt-[60px]">
        <CustomFadeIn
          ...
          <div className="flex justify-center">
            <div className="mt-[25px] mb-0 flex flex-wrap md:justify-center justify-start md:mx-0 mx-[30px] md:gap-x-6 md:gap-0 gap-x-4 gap-y-4">
              <ButtonPrimary1
                link={"#contact"}
                anchor={true}
                bg="bg-cyan-200 border-zinc-100 text-black scale-[100%] hover:scale-[110%]"
              >
              ...
              <ButtonSecondary1
                link={"/portfolio"}
                anchor={false}
                bg="bg-transparent hover:bg-black dark:hover:bg-white border-2 border-zinc-800 dark:border-white text-black hover:text-white dark:text-white dark:hover:text-black fill-black hover:fill-white dark:fill-white dark:hover:fill-black scale-[100%] hover:scale-[110%]"
              >
                <span>Portfolio</span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
