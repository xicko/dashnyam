    ...
    <section className='flex justify-center'>
      <div className='flex justify-center flex-col md:w-[1400px] md:pt-[168px] pt-[60px] md:pb-[85px] pb-[0px]'>
        ...
        <animated.div
          ...
          ref={imageRef}
        >
          <div className='mt-[25px] mb-0 flex justify-center space-x-6'>
            <Link
              className='flex items-center space-x-[7px] w-fit bg-slate-200 text-slate-800 font-semibold border-1 p-[15px] rounded-lg text-[20px] border-slate-200 hover:shadow-[0_5px_60px_-15px_rgba(186,230,253,1)] shadow-[0px_0px_50px_-15px_rgba(186,230,253,0.4)] transition ease duration-700'
              href={'#contactform'}
              data-scroll-to
            >
              <span>Contact</span>
