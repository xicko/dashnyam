  ...
  return (
    <section className='md:w-[460px] md:mx-10 bg-black md:bg-opacity-20 bg-opacity-0 md:rounded-3xl p-10 md:mt-4 md:mb-0 mb-14 space-y-6'>
        <div className='space-y-2'>
            <p className='font-bold customfonttitle tracking-wider text-xl'>&#8226; What kind of filters do you create?</p>
        ...
        <div className='space-y-2'>
            <p className='font-bold customfonttitle tracking-wider text-xl'>&#8226; How long does it take to create a filter?</p>
        ...
        <div className='space-y-2'>
            <p className='font-bold customfonttitle tracking-wider text-xl'>&#8226; What is the value for creating an effect?</p>
