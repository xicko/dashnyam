    ...
    <section className="flex justify-center mb-8">
      <div className="text-white md:px-20 px-8 my-[10px] font-semibold ">
        ...
        <form onSubmit={handleSubmit} className="mt-0">
          ...
          <label className="block text-sm text-gray-200 mb-2">Ideas</label>
          <textarea
            name="ideas"
          ...
          <label className="block text-sm text-gray-200 mb-2">Budget</label>
          <input
            type="text"
            name="budget"
          ...
          {formData.filterReason === "other" && (
            <>
              <label className="block text-sm text-gray-200 mb-2">Other</label>
              <input
                type="text"
                name="otherReason"
