      ...
      <div className='text-white md:px-20 px-8 my-[10px] font-semibold'>
        <form onSubmit={handleSubmit} className='mt-0'>
          ...
          <div className='flex justify-center'>
            <button
              type='submit'
              className='flex items-center space-x-[6px] w-fit bg-slate-50 text-xl font-semibold text-slate-700 py-2.5 px-5 rounded-lg ease-linear duration-150 transition shadow-[0_5px_60px_-15px_rgba(197,227,242,0)] hover:shadow-[0_5px_60px_-15px_rgba(197,227,242,0.7)]'
            >
              <span>Submit</span>
