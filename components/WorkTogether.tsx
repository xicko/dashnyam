    ...
    <section className='flex justify-center mb-8 md:mt-8 mt-0'>
      <div className='text-white md:px-20 px-8 my-[10px] font-semibold'>
        <form onSubmit={handleSubmit} className='mt-0'>
          ...
          <label className='flex items-center space-x-[6px] w-fit text-xl text-gray-200 mb-2'>
            Ideas
          ...
          <input
            ...
            onChange={handleChange}
            className='w-full font-normal bg-opacity-30 rounded-lg border border-gray-300 bg-black p-2 mb-6 text-white text-lg ease-linear duration-150 transition shadow-[0_0px_30px_-15px_rgba(197,227,242,0)] md:hover:shadow-[0_0px_30px_-15px_rgba(197,227,242,1)] hover:shadow-[0_0px_30px_-12px_rgba(197,227,242,1)] md:focus:shadow-[0_0px_30px_-15px_rgba(197,227,242,1)] focus:shadow-[0_0px_30px_-12px_rgba(197,227,242,1)]'
            required
          ...
          <div className='flex justify-center'>
            <button
              type='submit'
              className='flex items-center space-x-[6px] w-fit bg-slate-50 text-xl font-semibold text-slate-700 py-2.5 px-5 rounded-lg scale-100 hover:scale-110 ease-linear duration-150 transition shadow-[0_5px_60px_-15px_rgba(197,227,242,0)] hover:shadow-[0_5px_60px_-15px_rgba(197,227,242,0.7)]'
            >
              <span>Submit</span>
