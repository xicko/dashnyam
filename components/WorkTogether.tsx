        ...
        <form onSubmit={handleSubmit} className='mt-0'>
          <div className='flex justify-start space-x-8  mb-0'>
            <div className='md:w-[200px] w-[145px] mb-4 md:mb-4'>
              <label className='block text-xl text-gray-700 dark:text-gray-200 mb-2'>Name</label>
              <input
                type='text'
                name='name'
                value={formData.name}
            ...
            <div className='md:w-[200px] w-[145px]'>
              <label className='block text-xl text-gray-700 dark:text-gray-200 mb-2'>
                Organization
              </label>
              <input
                type='text'
          ...
          <label className='flex items-center space-x-[6px] w-fit text-xl text-gray-700 dark:text-gray-200 mb-2'>
            Ideas
          ...
          <div className='flex justify-center'>
            <button
              type='submit'
              className='flex items-center space-x-[6px] w-fit bg-cyan-100 text-xl font-semibold text-slate-700 py-2.5 px-5 rounded-lg scale-100 hover:scale-110 ease-linear duration-150 transition shadow-[0_5px_60px_-15px_rgba(197,227,242,0)] hover:shadow-[0_5px_60px_-15px_rgba(197,227,242,0.7)]'
            >
              <span>Submit</span>
