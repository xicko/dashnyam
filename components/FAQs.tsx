...
const FAQs = () => {
  return (
    <section className='md:w-[460px] h-fit md:mx-10 bg-white md:bg-zinc-100 dark:bg-[#0f0f11] dark:md:bg-black dark:md:bg-opacity-20 bg-opacity-80 dark:bg-opacity-40 md:rounded-3xl p-10 md:mt-4 md:mb-0 mb-14 md:space-y-8 space-y-6'>
        ...
        <div className='min-w-full min-h-[2px] bg-zinc-600 bg-opacity-30 dark:bg-zinc-600 dark:bg-opacity-60 rounded-full'></div>
